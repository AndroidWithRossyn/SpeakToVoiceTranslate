...
public class VoiceActivity extends BaseActivity {
    ...
    protected void initView(Bundle savedInstanceState) {
        AdUtils.showNativeAd(VoiceActivity.this, Constants.adsJsonPOJO.getParameters().getNative_id().getDefaultValue().getValue(), (LinearLayout) findViewById(R.id.native_ads), true);
        voiceActivity = this;
